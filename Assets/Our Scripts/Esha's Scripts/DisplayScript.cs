...
public class DisplayScript : MonoBehaviour
{
    ...
    // after finished dialogue, make boxes disappear
    public void symptomBoxesOff() {
        ChestPain1.SetActive(false);
        Fatigue2.SetActive(false);
        ShortBreath3.SetActive(false);
        Nausea4.SetActive(false);
        ColdSweat5.SetActive(false);
        Dizziness6.SetActive(false);
    }
}